  ...
  if (!open) {
    return (
      <button
        ...
        className="hidden md:flex items-center gap-2 px-3 py-1.5 text-xs text-sand-400 bg-sand-50 hover:bg-sand-100 border border-sand-200 rounded-lg transition-colors w-56"
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="font-medium truncate">
                            {item.nom_complet || item.employe_nom || item.nom || item.description}
                          </div>
                          {(item.code || item.employe_code) && (
